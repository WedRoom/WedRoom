...
<%
	...
	//FreeDAO freePro=new FreeDAO();
	//FreeDTO article=freePro.getArticle(num);
...
<head>
    ...
    <title>WedRoom</title>
    <link href="css/free_update.css" rel="stylesheet" type="text/css">
</head>
<body>
<%
	String id=null;
...
%>
    <div class="wrap">
        ...
        <article class="board_update">
            ...
            <form method="post" name="free_update" action="/WedRoom0/free_updatePro.do" onsubmit="return writeSave()">
                <table class="update">
                <input type="hidden" name="free_no" value="${article.free_no}">
	  			<input type="hidden" name="pageNum" value="${pageNum}"> 
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="title" class="board-title" placeholder="제목을 입력해주세요." value="${article.title}"></td>
                ...
                <div class="btn-write">
                    <input type="button" class="btn-cancel" onclick="window.history.back()" value="취소">
