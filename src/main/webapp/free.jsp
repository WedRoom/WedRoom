...
<body>
    <div class="wrap">
        ...
        <article class="freeboard">
            ...
            <form class="form-group" name="test"  action="/WedRoom0/free.do">
            ...
            <div class="board-list">
                <div class="board-detail">
                    <div class="board-write">
                        <a href="/WedRoom0/free_write.do">글쓰기</a>
                    </div>
                </div>
                <div class="board">
...
%>
                    ...
                    <c:if test="${pgList.startPage > pgList.blockSize}">
     					<a href="/WedRoom0/free.do?pageNum=${pgList.startPage-pgList.blockSize}&search=${search}&searchtext=${searchtext}" class="prev"><img src="./image/left-next.png"></a>
					</c:if>
					
					<c:forEach var="i" begin="${pgList.startPage}" end="${pgList.endPage}">
					     <a href="/WedRoom0/free.do?pageNum=${i}&search=${search}&searchtext=${searchtext}" class="num">
					...
					<c:if test="${pgList.endPage <pgList.pageCount}">
					     <a href="/WedRoom0/free.do?pageNum=${pgList.startPage+pgList.blockSize}&search=${search}&searchtext=${searchtext}" class="next"><img src="./image/right-next.png"></a>
					</c:if>  
                    </div>
                </div>
            </div>
