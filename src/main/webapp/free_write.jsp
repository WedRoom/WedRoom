...
<head>
    ...
    <title>WedRoom</title>
    <link href="css/free_write.css" rel="stylesheet" type="text/css">
    ...
    <div class="wrap">
        ...
        <nav class="nav">
            <ul class="menu">
                ...
                <li><a href="#">공지사항</a></li>
                <li><a href="#">성향게시판</a></li>
            </ul>
        </nav>
        <!-- 게시글 작성 -->
        <article class="board_write">
            <p class="tiele">자유게시판 작성</p>
            <form method="post" name="free_write" action="/WedRoom0/free_writePro.do" onsubmit="return writeSave()">
                ...
                <div class="btn-write">
                    <input type="button" class="btn-cancel" onclick="window.location='/WedRoom0/free.do'" value="취소">
