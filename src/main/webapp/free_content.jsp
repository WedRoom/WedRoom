...
%>
            <div class="board_control">
                <a href="#" class="free_update" onclick="document.location.href='/WedRoom0/free_update.do?free_no=${article.free_no}&pageNum=${pageNum}'">수정</a>&nbsp;&nbsp;
                <a href="#" class="free_delete" onclick="document.location.href='/WedRoom0/free_delete.do?free_no=${article.free_no}&pageNum=${pageNum}'">삭제</a>
            </div>
<%} else { %>
			<div class="board_control">
...
<%}%>
        ...
        <article class="board_comment">
            <div class="comment">
                ...
                <form class="text" method="post" action="/WedRoom0/free_comwritePro.do?free_no=${article.free_no}&id=<%=id%>">
...
<%--             	<c:if test="${count==0}">
    			...
    			<input type="hidden" name="comment_no" value="${list.comment_no}" />
                    ...
                    <form class="btn-comment">
                        <input type="button" class="btn-update" onclick="popup()" value="수정">
                        <input type="button" class="btn-delete" onclick="document.location.href='/WedRoom0/free_comdelete.do?free_no=${article.free_no}&pageNum=${pageNum}&comment_no=${list.comment_no}'" value="삭제">
                    </form>
                </table>
                </form>
                </div>
...
<script type="text/javascript">
	function popup(){
		...
		var url= "free_comupdate.do?free_no=${article.free_no}&pageNum=${pageNum}&comment_no=${list.comment_no}";
