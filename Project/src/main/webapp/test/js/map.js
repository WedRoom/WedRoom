...
var markerPosition = kakao.maps.event.addListener(
	map,
	"click",
	function (mouseEvent) {
		// 클릭한 위치에 마커를 표시합니다
...
var iwContent =
		'<div style="padding:5px;"><a href="content.do">방 자세히보기!</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
