		...
		<!-- 바디 -->
			<center>
				...
				<a href="/Project/share_write.do"> <img
					src="test/img/Add button flat color ui icon.jpeg" class="btn_map_add"
					href="#" />
				</a>
				...
				<script type="text/javascript">
						...
						<c:forEach var="room" items="${roomList}">
							var content= '<div style="padding:5px; "><a href="share_detail.do?room_no=${room.room_no}"">${room.title} 자세히보기!</a></div>'
							var lat=${room.lat}
							var lng=${room.lng}
